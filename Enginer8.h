...
namespace ENJPROG {
	...
	/// <summary>
	/// Summary for Enginer8
	/// 	/// </summary>
	public ref class Enginer8 : public System::Windows::Forms::Form
	{
	public:
		Enginer8(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->unengi4->Click += gcnew System::EventHandler(this, &Enginer8::unengi4_Click);
			// 
			// unengi5
			// 
			...
			this->unengi5->Click += gcnew System::EventHandler(this, &Enginer8::unengi5_Click);
			// 
			// Enginer8
			// 
			...
			this->Name = L"Enginer8";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Enginer8";
			this->Load += gcnew System::EventHandler(this, &Enginer8::Enginer8_Load);
...
#pragma endregion
	...
	private: System::Void Enginer8_Load(System::Object^ sender, System::EventArgs^ e) {
	}
