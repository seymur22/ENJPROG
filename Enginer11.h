...
namespace ENJPROG {
	...
	/// 	/// </summary>
	public ref class Enginer11 : public System::Windows::Forms::Form
	{
	public:
		Enginer11(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->unengi4->Click += gcnew System::EventHandler(this, &Enginer11::unengi4_Click);
			// 
			// unengi5
			// 
			...
			this->unengi5->Click += gcnew System::EventHandler(this, &Enginer11::unengi5_Click);
			// 
			// Enginer11
			// 
			...
			this->Name = L"Enginer11";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Enginer11";
			this->Load += gcnew System::EventHandler(this, &Enginer11::Enginer11_Load);
...
#pragma endregion
	...
	private: System::Void Enginer11_Load(System::Object^ sender, System::EventArgs^ e) {
	}
