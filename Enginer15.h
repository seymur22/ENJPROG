...
namespace ENJPROG {
	...
	/// <summary>
	/// Summary for Enginer15
	/// 	/// </summary>
	public ref class Enginer15 : public System::Windows::Forms::Form
	{
	public:
		Enginer15(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->unengi4->Click += gcnew System::EventHandler(this, &Enginer15::unengi4_Click);
			// 
			// unengi5
			// 
			...
			this->unengi5->Click += gcnew System::EventHandler(this, &Enginer15::unengi5_Click);
			// 
			// Enginer15
			// 
			...
			this->Name = L"Enginer15";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Enginer15";
			this->Load += gcnew System::EventHandler(this, &Enginer15::Enginer15_Load);
...
#pragma endregion
	...
	private: System::Void Enginer15_Load(System::Object^ sender, System::EventArgs^ e) {
	}
