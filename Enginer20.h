...
namespace ENJPROG {
	...
	/// <summary>
	/// Summary for Enginer20
	/// 	/// </summary>
	public ref class Enginer20 : public System::Windows::Forms::Form
	{
	public:
		Enginer20(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->unengi4->Click += gcnew System::EventHandler(this, &Enginer20::unengi4_Click);
			// 
			// unengi5
			// 
			...
			this->unengi5->Click += gcnew System::EventHandler(this, &Enginer20::unengi5_Click);
			// 
			// Enginer20
			// 
			...
			this->Name = L"Enginer20";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Enginer20";
			this->Load += gcnew System::EventHandler(this, &Enginer20::Enginer20_Load);
...
#pragma endregion
	...
	private: System::Void Enginer20_Load(System::Object^ sender, System::EventArgs^ e) {
	}
