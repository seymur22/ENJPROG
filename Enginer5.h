...
namespace ENJPROG {
	...
	/// <summary>
	/// Summary for Enginer5
	/// 	/// </summary>
	public ref class Enginer5 : public System::Windows::Forms::Form
	{
	public:
		Enginer5(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->unengi4->Click += gcnew System::EventHandler(this, &Enginer5::unengi4_Click);
			// 
			// unengi5
			// 
			...
			this->unengi5->Click += gcnew System::EventHandler(this, &Enginer5::unengi5_Click);
			// 
			// Enginer5
			// 
			...
			this->Name = L"Enginer5";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Enginer5";
			this->Load += gcnew System::EventHandler(this, &Enginer5::Enginer5_Load);
...
#pragma endregion
	...
	private: System::Void Enginer5_Load(System::Object^ sender, System::EventArgs^ e) {
	}
