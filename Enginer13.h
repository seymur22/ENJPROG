...
namespace ENJPROG {
	...
	/// <summary>
	/// Summary for Enginer13
	/// 	/// </summary>
	public ref class Enginer13 : public System::Windows::Forms::Form
	{
	public:
		Enginer13(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->unengi4->Click += gcnew System::EventHandler(this, &Enginer13::unengi4_Click);
			// 
			// unengi5
			// 
			...
			this->unengi5->Click += gcnew System::EventHandler(this, &Enginer13::unengi5_Click);
			// 
			// Enginer13
			// 
			...
			this->Name = L"Enginer13";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Enginer13";
			this->Load += gcnew System::EventHandler(this, &Enginer13::Enginer13_Load);
...
#pragma endregion
	...
	private: System::Void Enginer13_Load(System::Object^ sender, System::EventArgs^ e) {
	}
