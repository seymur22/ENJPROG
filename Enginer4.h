#pragma once
#include "Enginer4_1h.h"
#include "Enginer4_2h.h"
#include "Enginer4_3h.h"
#include "Enginer4_4h.h"
#include "Enginer4_5h.h"
...
namespace ENJPROG {
	...
	/// <summary>
	/// Summary for Enginer4
	/// 	/// </summary>
	public ref class Enginer4 : public System::Windows::Forms::Form
	{
	public:
		Enginer4(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->unengi1->Click += gcnew System::EventHandler(this, &Enginer4::unengi1_Click);
			// 
			// unengi2
			// 
			...
			this->unengi2->Click += gcnew System::EventHandler(this, &Enginer4::unengi2_Click);
			// 
			// unengi3
			// 
			...
			this->unengi3->Click += gcnew System::EventHandler(this, &Enginer4::unengi3_Click);
			// 
			// unengi4
			// 
			...
			this->unengi4->Click += gcnew System::EventHandler(this, &Enginer4::unengi4_Click);
			// 
			// unengi5
			// 
			...
			this->unengi5->Click += gcnew System::EventHandler(this, &Enginer4::unengi5_Click);
			// 
			// Enginer4
			// 
			...
			this->Name = L"Enginer4";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Enginer4";
			this->Load += gcnew System::EventHandler(this, &Enginer4::Enginer4_Load);
